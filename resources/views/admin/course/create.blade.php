    ...
    <div class="sb2-2-3">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <textarea name="short_descp" id="summernote" placeholder="Enter Short Description"></textarea>
                @error('short_descp')
                <span class="text-danger">{{ $message }}</span>
              @enderror
              </div>
              <div class="form-group">
                ...
                <input class="form-control" type="file" name="course_image"  onchange="CourseImage(this)">
                @error('course_image')
                <span class="text-danger">{{ $message }}</span>
              @enderror
              <img src="" id="mainThmb">
